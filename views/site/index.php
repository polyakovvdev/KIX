...
<body>
        ...
        <div class="header">
            <ul class="header__list">
                ...
                <li class="header__element">
                    ...
                    <a href="https://yandex.ru/maps/51/samara/house/molodogvardeyskaya_ulitsa_151/YUkYdwdoSkIAQFtpfX5xcHxmYw==/?ll=50.108377%2C53.201057&z=17.15" target="_blank" class="header__address-link">г. Самара, ул. Молодогвадрейская, 151, оф. 34</a>
                </li>
                <li class="header__element">
            ...
            <div class="banner-social">
                ...
                <div class="banner_title__social">
                    <ul class="banner_title__social-links">
                        <li>
                            <a href="https://rickrolled.com/" target="_blank" class="banner_title__social-link"><img src="/template/images/instagram.png" alt="Instagram"></a>
                        </li>
                        <li>
    ...
    <div class="navigation">
        <ul>
            <li>kix</li>
            <li><a href="/catalog/male/" class="button-nav">мужчины</a></li>
